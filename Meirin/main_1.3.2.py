...
def pop():
	msgbox=QMessageBox.information(widget,'StarryProject-L 1.3.2 "Selaginella 9"',"地震震后建筑照片贴标程序\n版本　1.3.2　2024/10/9\nby　4N☆E　<Starry4N@stu.scu.edu.cn>\n2024　StarryProject™\n内部软件　请勿外传\n\nV1.3新增特性：\n1.新功能：「组合式」贴标，现已可用！\nV1.3.1:「混合式」模块窗口标题文字更正；\nV1.3.2：「钢筋裸露」复选框现在单击就可以勾选，并且调整其选中时对其他复选框的逻辑。\n\n\n——好了，不要碍事了\n　　你就是这里看门的吧？\n——正因为是门卫才要碍你的事啊")
	if msgbox==QMessageBox.Ok:
		QMessageBox.about(widget,'已知问题',"①更改目录路径后需要返回主菜单再进入才能更新显示。")
app=QApplication(sys.argv)
widget=QWidget()
widget.setWindowTitle('StarryProject-L 1.3.2')
