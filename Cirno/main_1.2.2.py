...
def pop():
	msgbox=QMessageBox.information(widget,'StarryProject-L 1.2.2 "Hailstorm"',"地震震后建筑照片贴标程序\n版本　１.２.２　２０２４／８／１３\nｂｙ　４Ｎ☆Ｅ　＜Ｓｔａｒｒｙ４Ｎ＠ｓｔｕ．ｓｃｕ．ｅｄｕ．ｃｎ＞\n２０２４　ＳｔａｒｒｙＰｒｏｊｅｃｔ™\n内部软件　请勿外传\n\nＶ１.２新增特性：\n１.修复了「整体结构」板块生成错误语句的问题；\n２.替换缩进符并优化代码，代码大小减少１５％；\n３.ＵＩ文字修改并中文化；\n４.历史记录输出列表优化；\n５.ＵＩ布局优化；\n６.多选框逻辑添加并修正。\nＶ１.２.１：优化「整体结构」输出　优化程序稳定性；\nＶ１.２.２：ＵＩ文字微调。\n\n\n——不会再让你回到陆地上了啊！\n——是你吧。让天这么冷")
	if msgbox==QMessageBox.Ok:
		QMessageBox.about(widget,'已知问题',"①更改目录路径后需要返回主菜单再进入才能更新显示。")
app=QApplication(sys.argv)
widget=QWidget()
widget.setWindowTitle('StarryProject-L 1.2.2')
